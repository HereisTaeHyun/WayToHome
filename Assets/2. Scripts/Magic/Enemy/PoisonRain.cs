...
public class PoisonRain : MagicBase
{
    public MagicType magicType;
    private Vector2 moveDir;
    private Vector2 newVelocity;

    private readonly int poisonOffHash = Animator.StringToHash("PoisonOff");
    ...
    protected override void ReturnToOriginPool()
    {
        ...
        else
        {
            ...
            anim.SetTrigger(poisonOffHash);
        }
    }

    // PoisonOff 애니메이션 이벤트로 재생
